...
namespace DXInfo.Role
{
    ...
    public class SqlRoleProvider : RoleProvider
    {
        ...
        public override void CreateRole(string roleName)
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    cmd.Parameters.Add(CreateInputParam("@ApplicationName", SqlDbType.NVarChar, ApplicationName));
                    cmd.Parameters.Add(CreateInputParam("@RoleName", SqlDbType.NVarChar, roleName));
                    cmd.Parameters.Add(CreateInputParam("@Description", SqlDbType.NVarChar, ""));
                    cmd.ExecuteNonQuery();
        ...
        public void CreateRole(string roleName,string description)
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    cmd.Parameters.Add(CreateInputParam("@ApplicationName", SqlDbType.NVarChar, ApplicationName));
                    cmd.Parameters.Add(CreateInputParam("@RoleName", SqlDbType.NVarChar, roleName));
                    cmd.Parameters.Add(CreateInputParam("@Description", SqlDbType.NVarChar, description));
                    cmd.ExecuteNonQuery();
        ...
        public bool DeleteRole(Guid roleId, bool throwOnPopulatedRole)
        {
            //SecUtility.CheckParameter(ref roleName, true, true, true, 256, "roleName");
            ...
            try
            {
                ...
                try
                {
                    ...
                    SqlCommand cmd = new SqlCommand("dbo.aspnet_Roles_DeleteRoleById", holder.Connection);
                    ...
                    cmd.Parameters.Add(p);
                    cmd.Parameters.Add(CreateInputParam("@ApplicationName", SqlDbType.NVarChar, ApplicationName));
                    cmd.Parameters.Add(CreateInputParam("@RoleId", SqlDbType.UniqueIdentifier, roleId));
                    cmd.Parameters.Add(CreateInputParam("@DeleteOnlyIfRoleIsEmpty", SqlDbType.Bit, throwOnPopulatedRole ? 1 : 0));
                    cmd.ExecuteNonQuery();
                    int returnValue = GetReturnValue(cmd);
